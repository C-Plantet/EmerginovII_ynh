...
(function (mod) {
  ...
  function autoCloseGT(cm) {
    ...
    for (var i = 0; i < ranges.length; i++) {
      ...
      if (!tagName || tok.type == "string" && (tok.end != pos.ch || !/[\"\']/.test(tok.string.charAt(tok.string.length - 1)) || tok.string.length == 1) || tok.type == "tag" && tagInfo.close || tok.string.indexOf("/") == tok.string.length - 1 || // match something like <someTagName />
